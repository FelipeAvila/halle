...
var templateUrl = currentScriptPath.replace(new RegExp("ng-walkthrough.js.*"), '/ng-walkthrough/ng-walkthrough.html');
var iconsUrl = currentScriptPath.replace(new RegExp("ng-walkthrough.js.*"), 'ng-walkthrough/icons/');
